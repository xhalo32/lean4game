    ...
    flake-parts.lib.mkFlake { inherit inputs; } {
      ...
      perSystem =
...

        {
          ...
          # system.
          packages.lean4game = pkgs.stdenv.mkDerivation {
            name = "lean4game-client";
                ...
                http {
                  ...
                  server {
                    ...
                    location /websocket/ {
                      ...
                      proxy_pass https://server/websocket/;
